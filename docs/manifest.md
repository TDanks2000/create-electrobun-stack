...
```json
{
  "$schema": "https://unpkg.com/create-electrobun-stack@1.0.0-rc.5/docs/ces.schema.json",
  "version": "1.0.0-rc.5",
  "createdAt": "2026-05-10T00:00:00.000Z",
  "reproducibleCommand": "bunx create-electrobun-stack@1.0.0-rc.5 my-app --template minimal ...",
  "projectName": "my-app",
  "packageName": "my-app",
